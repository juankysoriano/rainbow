...
public class InkDrop {
    ...
    private static final float MINIMUM_RADIUS = LibraryApplication.getContext().getResources().getDimension(R.dimen.ink_drop_min_radius);
    private static final float MAXIMUM_RADIUS = LibraryApplication.getContext().getResources().getDimension(R.dimen.ink_drop_max_radius);
    private static final float RADIUS_STEP = LibraryApplication.getContext().getResources().getDimension(R.dimen.ink_drop_step);
    private float x;
    private float y;
    private float xOld;
    private float yOld;
