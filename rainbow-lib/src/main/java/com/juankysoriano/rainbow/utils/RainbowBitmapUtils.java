...
public class RainbowBitmapUtils {
    ...
    public static Bitmap getBitmap(int resId, int reqWidth, int reqHeight, int mode) {
        try {
    ...
    public static Bitmap getBitmap(String path, int reqWidth, int reqHeight, int mode) {
        try {
            if (mode == RainbowImage.LOAD_CENTER_CROP) {
    ...
    public static Bitmap getBitmap(File file, int reqWidth, int reqHeight, int mode) {
        try {
            if (mode == RainbowImage.LOAD_CENTER_CROP) {
    ...
    public static Bitmap getBitmap(Uri uri, int reqWidth, int reqHeight, int mode) {
        try {
            if (mode == RainbowImage.LOAD_CENTER_CROP) {
