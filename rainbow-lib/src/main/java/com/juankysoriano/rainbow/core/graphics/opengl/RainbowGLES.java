...
import com.juankysoriano.rainbow.core.graphics.opengl.tess.RainbowGLUtessellator;
import com.juankysoriano.rainbow.core.graphics.opengl.tess.RainbowGLUtessellatorCallbackAdapter;
...
public class RainbowGLES extends RainbowGL {
  // ........................................................
  ...
  public RainbowGLES(RainbowGraphicsOpenGL graphics) {
    super(graphics);
    glu = new RainbowGLU();
  }
  ...
  public void init(GL10 igl) {
    ...
    if (!hasFBOs()) {
      throw new RuntimeException(RainbowGL.MISSING_FBO_ERROR);
    }
    if (!hasShaders()) {
      throw new RuntimeException(RainbowGL.MISSING_GLSL_ERROR);
    }
  }
  ...
  @Override
  protected void getGL(RainbowGL pgl) {
    RainbowGLES pgles = (RainbowGLES)pgl;
    this.gl = pgles.gl;
  ...
  protected class Tessellator implements RainbowGL.Tessellator {
    protected RainbowGLUtessellator tess;
    protected TessellatorCallback callback;
    protected GLUCallback gluCallback;

    public Tessellator(TessellatorCallback callback) {
      this.callback = callback;
      tess = RainbowGLU.gluNewTess();
      gluCallback = new GLUCallback();

      RainbowGLU.gluTessCallback(tess, RainbowGLU.GLU_TESS_BEGIN, gluCallback);
      RainbowGLU.gluTessCallback(tess, RainbowGLU.GLU_TESS_END, gluCallback);
      RainbowGLU.gluTessCallback(tess, RainbowGLU.GLU_TESS_VERTEX, gluCallback);
      RainbowGLU.gluTessCallback(tess, RainbowGLU.GLU_TESS_COMBINE, gluCallback);
      RainbowGLU.gluTessCallback(tess, RainbowGLU.GLU_TESS_ERROR, gluCallback);
    }

    @Override
    public void setCallback(int flag) {
      RainbowGLU.gluTessCallback(tess, flag, gluCallback);
    }

    @Override
    public void setWindingRule(int rule) {
      setProperty(RainbowGLU.GLU_TESS_WINDING_RULE, rule);
    }

    public void setProperty(int property, int value) {
      RainbowGLU.gluTessProperty(tess, property, value);
    }
    ...
    public void beginPolygon(Object data) {
      RainbowGLU.gluTessBeginPolygon(tess, data);
    }

    @Override
    public void endPolygon() {
      RainbowGLU.gluTessEndPolygon(tess);
    }

    @Override
    public void beginContour() {
      RainbowGLU.gluTessBeginContour(tess);
    }

    @Override
    public void endContour() {
      RainbowGLU.gluTessEndContour(tess);
    }
    ...
    public void addVertex(double[] v, int n, Object data) {
      RainbowGLU.gluTessVertex(tess, v, n, data);
    }

    protected class GLUCallback extends RainbowGLUtessellatorCallbackAdapter {
      @Override
  ...
  protected String tessError(int err) {
    return RainbowGLU.gluErrorString(err);
  }
  ...
  static {
    ...
    TESS_WINDING_NONZERO = RainbowGLU.GLU_TESS_WINDING_NONZERO;
    TESS_WINDING_ODD     = RainbowGLU.GLU_TESS_WINDING_ODD;
    TESS_EDGE_FLAG       = RainbowGLU.GLU_TESS_EDGE_FLAG;
