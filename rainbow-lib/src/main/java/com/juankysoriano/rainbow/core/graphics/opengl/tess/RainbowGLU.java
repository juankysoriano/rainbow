...
public class RainbowGLU {
  ...
  public static final RainbowGLUtessellator gluNewTess() {
    return GLUtessellatorImpl.gluNewTess();
  }  
  
  public static final void gluTessCallback(RainbowGLUtessellator tess, int which, RainbowGLUtessellatorCallback callback) {
    ((GLUtessellatorImpl)tess).gluTessCallback(which, callback);
  }

  public static final void gluTessBeginPolygon(RainbowGLUtessellator tess, Object data) {
    ((GLUtessellatorImpl)tess).gluTessBeginPolygon(data); 
  }
  
  public static final void gluTessEndPolygon(RainbowGLUtessellator tess) {
    ((GLUtessellatorImpl)tess).gluTessEndPolygon();    
  }
                                                                                                                                                
  public static final void gluTessProperty(RainbowGLUtessellator tess, int which, double value) {
    ((GLUtessellatorImpl)tess).gluTessProperty(which, value);
  }

  public static final void gluTessBeginContour(RainbowGLUtessellator tess) {
    ((GLUtessellatorImpl)tess).gluTessBeginContour();
  }

  public static final void gluTessEndContour(RainbowGLUtessellator tess) {
    ((GLUtessellatorImpl)tess).gluTessEndContour();
  }

  public static final void gluTessVertex(RainbowGLUtessellator tess, double[] coords, int offset, Object vdata) {
