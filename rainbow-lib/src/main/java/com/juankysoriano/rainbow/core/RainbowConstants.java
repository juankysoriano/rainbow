...
/**
 * Numbers shared throughout imagine.core.
 * <p/>
...
public interface RainbowConstants {
    ...
    public static final int DEFAULT_FRAME_RATE = 120;
    // vertex fields
    ...
    static final String ANDROID2D = "imagine.core.PGraphicsAndroid2D";
    ...
    // platform IDs for Imagine.platform
    ...
    @Deprecated
    public static final int QUAD_BEZIER_VERTEX = 2;  // should not have been exposed
    ...
    static final int LOAD_CENTER_INSIDE = 0;
    static final int LOAD_CENTER_CROP = 1;
    static final int LOAD_ORIGINAL_SIZE = 2;
